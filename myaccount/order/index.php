    ...
    <div class="flex flex-col items-center justify-center relative bg-white w-full">
        ...
        <div class="w-full chooseCityOverlayMain  relative">
            ...
            <div class="w-full flex flex-col items-center justify-center">
                <div class="flex flex-col  px-5 sm:px-12 md:px-24 py-5 max-w-[1100px] w-full" id="singleOrderContainer">
                ...
                <div class="w-full  border-2 border-primary rounded-xl p-2 mt-4">
                ...
                <div class="text-black text-[15px] font-bold leading-snug mt-8">In Case of queries please get in touch with Extravelmoney</div>
