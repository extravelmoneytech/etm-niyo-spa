<div class="w-full  z-10 h-fit "
    ...
    <div class="h-fit flex flex-col bg-white p-3 py-3 sm:py-5" style="border-radius: 14px; box-shadow: 0px 10px 32px 0px rgba(0, 0, 0, 0.10); border: 1px solid rgba(14, 18, 38, 0.20);">
        ...
        <div class="forexSpace <?php echo ($widgetType == 'fx') ? 'activeSpace' : 'hiddenSpace'; ?>">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-col mt-4 w-full">
                    ...
                    <span class="text-gray-500 text-sm    sm:text-mediumFont  font-medium">Enter Amount
