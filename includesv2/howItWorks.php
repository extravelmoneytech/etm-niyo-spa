...
<section id="howItWorkSection" class="customMd:mt-20 ">

<div class="flex flex-col md:flex-row gap-2"><span class="text-[#18325b] text-2xl font-extrabold leading-9">Get Forex Cash</span><span class="text-primary text-2xl font-extrabold leading-9">3 Simple Steps</span></div>
                ...
                <div  class="mt-2">
                    <div id="howItWorksCardContainer" class="flex duration-300 ">
                        <div class="cards-wrapper w-full flex-none">
                            <div class="grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-3  min-w-[250px] w-full gap-4">
