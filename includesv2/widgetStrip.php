<div class="w-full mt-8">
    <div class="px-1 py-1 bg-[#ffbc4b]/10 rounded-lg border border-[#ffbc4b]/20 justify-center items-center gap-1 inline-flex overflow-hidden w-full">
        <div class="w-10 h-10 justify-center items-center gap-2.5 flex">
            <img class="w-8 h-8" src="public/images/info-bulb.png" />
        </div>
        <div class="grow shrink basis-0 text-[#0e1226] text-[12px] font-normal">
            USD recommended for easy exchange in
            <b>Bali, Vietnam, Maldives, Sri Lanka, </b>and <b> Hong Kong.</b>
        </div>
    </div>
</div>

<div class="w-full  bg-custom-gradient  p-3 rounded flex-col justify-center items-start gap-6 inline-flex mt-6 customMd:hidden">
    <div class="text-white text-[14px] font-semibold  leading-snug">6000 + RBI Authorized Exchange Houses on the Platform.</div>
</div>

<div class="mt-10  flex-col gap-2 flex mb-8 w-full customMd:hidden">
    <div class="flex flex-col gap-6">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
            ...
            <div class="flex flex-col text-start">
                <p class="text-base xs:text-lg w-full font-bold">Save More</p>
                <span class="text-black/60 text-mediumFont font-normal  leading-normal mt-2">5%+ better than market rates.</span>
            </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
            ...
            <div class="flex flex-col text-start">
                <p class="text-base xs:text-lg w-full font-bold">Fast Credit</p>
                <span class="text-black/60 text-mediumFont font-normal  leading-normal mt-2">Delivery in 48 working hours.</span>
            </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
            ...
            <div class="flex flex-col text-start">
                <p class="text-base xs:text-lg w-full font-bold">Expert Help</p>
                <span class="text-black/60 text-mediumFont font-normal  leading-normal mt-2">Professional support,every step</span>
            </div>
