import {CONSTANTS,formatAmount} from '../orderv3/common.js?ver=1.5';
  ...
  async addProduct(type, rowId) {
      ...
      try {
          ...
          if (type === 'add') {
            ...
            if (AppState.getState('productType', 'addProductState') === 'forexCard') {
                product = 'Forex Card'
            }
            else if (AppState.getState('productType', 'addProductState') === 'currency') {
                product = 'Currency'
            }
  ...
  async updateDeliveryDetails() {
      ...
      try {
          ...
          const params = new URLSearchParams({
              ...
              pincode: AppState.deliveryState.ddPin
          });
